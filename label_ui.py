...
class Ui_Form(object):
    def setupUi(self, Form):
        # Form.setWindowIcon(QIcon("adell.ico"))
        ...
        self.verticalLayout_4.addWidget(self.lineEditCurrentLabel)
        ...
        self.lineEditLastCapture = QtWidgets.QLineEdit(self.groupBox_3)
        self.lineEditLastCapture.setEnabled(False)
        self.lineEditLastCapture.setObjectName("lineEditLastCapture")
        self.verticalLayout_7.addWidget(self.lineEditLastCapture)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(_translate("Form", "Last Captured Label:"))
